...
#ifdef __IPHONE_7_0
    textSize = [text boundingRectWithSize:CGSizeMake(screenSize.width - kHorizontalMargin*4.f, 1000.f) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:font} context:nil].size;
#else
    textSize = [text sizeWithFont:font constrainedToSize:CGSizeMake(screenSize.width - kHorizontalMargin*4.f, 1000.f) lineBreakMode:UILineBreakModeWordWrap];
#endif
...
#ifdef __IPHONE_7_0
    titleSize = [title sizeWithAttributes:@{NSFontAttributeName:kTitleFont}];
#else
